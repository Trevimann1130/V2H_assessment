...
technologies_global = {
    'PV': {
        'PEF': 0,                     # product environmental footprint of the PV [Pt/kWp]
        'PVdegradation': 0.0057,          # annual PV degradation  [%/a]
        'pv_reference_kwp': 1.0,         # reference value
        'maintenance_rate_PV': 0.01
    },
    'BESS': {
        'PEF': 1216,                     # product environmental footprint of the BESS [Pt/kWh]
        ...
        'power_kW': 5,                  # max charging/discharging capacities of battery in kW
    ...
    'EV': {
        ...
        'N_EV_bidirectional': N_EV * r_EV_V2H,
        'PEF': 0,
        'capacity_kWh': 60,
        'max_soc': 1.0,
        'initial_soc': 0.5,
        ...
        # 'holidays': [100, 101],  # Feiertage
        # 'holiday_commute_kWh': 100,
        'charge_c_rate_table': [
...
technologies_local = {
    'Vienna': {
        # PV costs
        'CPV': 1100,    # investment costs PV [€/kWp]
        'Cfeed_community_PV': 0.17,
